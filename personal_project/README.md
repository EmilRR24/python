# Gamer Kings
Gamer Kings is a media website that involves the use of live streaming and Esporting events as a viewing platform. The backend is built with Python and Flask, and the frontend design with the use of Bootstrap and jQuery gives the user a more dynamic and responsive experience.
## Features
